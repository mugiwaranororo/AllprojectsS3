...
int main()
{
    ...
    print_matrix("m3 + m3", m3_plus_m3, ROWS3, COLS3);
    print_matrix("m4 + m5_tr", m4_plus_m5tr, ROWS4, COLS4);
    print_matrix("m5 + m4_tr", m5_plus_m4tr, ROWS5, COLS5);
    mul(m2, m2, ROWS2, COLS2, COLS2, m2_times_m2);
    mul(m4, m5, ROWS4, COLS4, COLS5, m4_times_m5);
    mul(m5, m4, ROWS5, COLS5, COLS4, m5_times_m4);
    print_matrix("m2 * m2", m2_times_m2, ROWS2, COLS2);
    print_matrix("m4 * m5", m4_times_m5, ROWS4, COLS5);
    print_matrix("m5 * m4", m5_times_m4, ROWS5, COLS4);
